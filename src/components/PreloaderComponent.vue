<template>
    <div class="preloader">
      ...
      >
        ...
        <!-- Руль -->
        <line x1="70" y1="30" x2="80" y2="15" stroke="#f1c40f" stroke-width="4" stroke-linecap="round" />
  
        <!-- Седло -->
        <line x1="50" y1="30" x2="40" y2="15" stroke="#f1c40f" stroke-width="4" stroke-linecap="round" />
  
        <!-- Педаль -->
        <circle class="pedal" cx="50" cy="60" r="6" fill="#f39c12" />
        <line class="pedal-arm" x1="50" y1="60" x2="70" y2="55" stroke="#f39c12" stroke-width="4" stroke-linecap="round" />
      </svg>
